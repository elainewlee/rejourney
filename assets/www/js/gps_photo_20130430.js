...
//______________________________________Start of GPS Logging____________________________________________
...
//______________________________________End of GPS Logging____________________________________________

//______________________________________Start of Photo Capture____________________________________________
...
// $("#photoPrompt").on('click', function(){ //Check if user is in new location, and prompt user to take photo,if true.
//     // if currentLocation != previous location
//     // currentLocation = navigator.geolocation.getCurrentPosition(onSuccess, onError, { //
//         // frequency: 30000,
//         // enableHighAccuracy: true
//     navigator.notification.alert(
//         'Take a photo to record this point on your journey.', // message
//         'Time to Take a Photo', // callback
//         'Dismiss prompt', // title
//         'Button name'
//     );
// };

//______________________________________End of Photo Capture____________________________________________



// //______________________________________WORKING ON THIS____________________________________________
